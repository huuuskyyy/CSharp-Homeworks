...
//you can see the diagram in School.cs -> SchoolDiagram.cd
...
namespace School
{
    class Program
    {
        static void Main()
        {
            //create new school through the test method
            //check CreateTest class for more info
            School example = CreateTest.New();
            CreateTest.DisplayTest(example);
